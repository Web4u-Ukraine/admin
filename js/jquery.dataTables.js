...
(/** @lends <global> */function($, window, document, undefined) {
	...
	DataTable.defaults = {
		 ...
		 * down events that DataTables shows when pagination is enabled. It can be
		 ...
		 *  
		 *  @example
		 *    // Setting the default display length as well as length events
		 ...
		 * events (sizes are 10, 25, 50 and 100). Requires pagination (bPaginate).
		 *  @type boolean
		 *  @default true
		 *  @dtopt Features
		 * 
		 ...
		 * this to a custom setting using a pop-up events.
		 *  @type int
		 *  @default 10
		 *  @dtopt Options
		 * 
		...
		"oLanguage": {
			...
			/**
			 * Detail the action that will be taken when the drop down events for the
	...
	DataTable.models.oSettings = {
		...
		/**
		 * List of options that can be used for the user selectable length events.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@link DataTable.defaults}.
		 *  @type array
		 *  @default []
